	  ...
	  <div class="col-md-6 col-6">
       ...
       <div class="col-md-6 col-6">
           <div class="trend_1r text-end">
               <h6 class="mb-0"><a class="button" href="phim/phimsapchieu.htm?tab=home">View All</a></h6>
           </div>
       </div>
	 </div>
		        ...
		        <div class="popular_2i1 row">
		          ...
		          <div class="col-md-8 col-8">
		            <div class="popular_2i1r">
		              ...
		              <p>${phim.getMoTa()}</p>
		              <h6 class="mb-0">
					    <a class="button" href="/DoAnWebCinema/datve/${currentDate}.htm">Book Now</a>
					  </h6>
		            </div>
		          </div>
		        </div>
                ...
                <div class="popular_2i1 row">
                    ...
                    <div class="col-md-8 col-8">
                        <div class="popular_2i1r">
                            ...
                            <h4 class="col_red">${phim.getTenPhim()}</h4>
                            <p>${phim.getMoTa()}</p>
                            <b><p>Release Date: ${phim.getNgayKhoiChieu()}</p></b>
                            <h6 class="mb-0">
								<a class="button" href="javascript:void(0)" onclick="openLightbox('${phim.getLinkTrailer()}', 'lightbox-${status.index}', 'lightbox-video-${status.index}')"><i class="fa fa-play-circle align-middle me-1"></i> Watch Trailer</a>
                            </h6>
                            <!-- Lightbox với ID riêng cho mỗi phim -->
...
<div class="play_m clearfix">
 ...
 <div class="row trend_1">
  <div class="col-md-12">
   <div class="trend_1l">
    <h4 class="mb-0"><i class="fa fa-youtube-play align-middle col_red me-1"></i> Box <span class="col_red">Office</span> #1</h4>
   </div>
  </div>
 </div>
								...
								<div class="col-md-4">
			  						<div class="trend_2im clearfix position-relative">
		   								<div class="trend_2im1 clearfix">
		   		 							<div class="grid">
		  										<figure class="effect-jazz mb-0">
													<a href="#"><img src="/DoAnWebCinema/uploads/daodien.jfif" class="w-100" alt="img25"></a>
	  											</figure>
	  										</div>
	   									</div>
...
const suggestions = {
    ...
    loggedIn: [
        { text: "Would you like to check out my surprise?", tag: "Gợi ý phim" },
        { text: "You might love my suggestion 😎", tag: "Gợi ý phim" },
        { text: "The movie <b><c:out value='${phimBanChayNhat[1]}'/></b> is really hot right now, should we book tickets?", tag: "Đặt vé phim <c:out value="${phimBanChayNhat[1] != null ? phimBanChayNhat[1].toLowerCase() : ''}" />" }
    ]
};
let usedTags = [];
